...
\name{Jinlang}{Wang}
\position{Objective: to obtain an internship/ coop in the summer or fall of 2021}
% \address{address}

\mobile{(412) 320-5283}
\email{jinlang226@outlook.com}
\homepage{http://jinlang226.github.io}
\github{jinlang226}
\linkedin{jinlangwang}
% \gitlab{gitlab-id}
